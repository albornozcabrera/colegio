    ...
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="myNavbar">
            ...
            <ul class="nav navbar-nav navbar-right">
                @if (Auth::check())
                <li class="dropdown">
                    <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" style="cursor: pointer; color: #4CAF50;" aria-expanded="false"><span id="nameUser" ng-model="nameUser">{{ Auth::user()->name }} {{ Auth::user()->lastname }} </span><span class="caret"></span></a>
...
<?= HTML::script('js/angularjs/controllers/header.js') ?>